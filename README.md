...
V3.5 (`versionCode 8`) adds hardware-attested Marin first-run enrollment while preserving the existing Portal ID, settings, encrypted credential storage, and memoryless fallback. Deploy its companion web contract before distributing this release.
