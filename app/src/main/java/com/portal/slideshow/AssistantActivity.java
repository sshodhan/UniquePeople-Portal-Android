    ...
    private final class PortalVoiceHarnessBridge {
        ...
        public void record(String payload) {
            ...
            try {
                ...
                copyString(inputData, data, "activationId", 160);
                copyString(inputData, data, "activationSource", 96);
                copyString(inputData, data, "activationStatus", 64);
                ...
                copyBoolean(inputData, data, "activationBound");
                copyBoolean(inputData, data, "activationRequiresAddressingEvidence");
                copyBoolean(inputData, data, "requiresAddressingEvidence");
                ...
                copyBoolean(inputData, data, "effectiveEchoCancellation");
                copyBoolean(inputData, data, "effectiveNoiseSuppression");
                copyBoolean(inputData, data, "effectiveAutoGainControl");
                copyNumber(inputData, data, "effectiveChannelCount");
                copyNumber(inputData, data, "effectiveSampleRate");
                copyNumber(inputData, data, "effectiveSampleSize");
                copyNumber(inputData, data, "effectiveLatency");
                copyString(inputData, data, "capabilityEchoCancellation", 96);
                copyString(inputData, data, "capabilityNoiseSuppression", 96);
                copyString(inputData, data, "capabilityAutoGainControl", 96);
                copyString(inputData, data, "capabilityChannelCount", 96);
                copyBoolean(inputData, data, "supportedEchoCancellation");
                copyBoolean(inputData, data, "supportedNoiseSuppression");
                copyBoolean(inputData, data, "supportedAutoGainControl");
